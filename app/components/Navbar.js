                ...
                <div className="flex items-center justify-between h-20">
                    ...
                    <div className="hidden md:block">
                        <div className="ml-10 flex items-baseline space-x-8">
                            ...
                            <Link href="#portfolio" className="text-gray-300 hover:text-white transition-colors duration-300 px-3 py-2 rounded-md text-sm font-medium">Portfolio</Link>
                            ...
                            <button className="bg-neon-orange hover:bg-orange-600 text-white px-6 py-2 rounded-full text-sm font-medium transition-all duration-300 shadow-[0_0_15px_rgba(255,138,0,0.3)] hover:shadow-[0_0_25px_rgba(255,138,0,0.5)]">
                                Contact Us
                            </button>
                        </div>
                    </div>
            ...
            {isOpen && (
                <div className="md:hidden bg-[#0A0F1E] border-b border-white/10">
                    <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                        ...
                        <button className="w-full text-left bg-neon-orange hover:bg-orange-600 text-white px-3 py-2 rounded-md text-base font-medium mt-4">
                            Contact Us
                        </button>
                    </div>
                </div>
